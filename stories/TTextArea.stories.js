	...
	template: 
        ...
        <div class="p-6 bg-gray-100">
            <div class="max-w-2xl">
                ...
                <t-card class="mt-5" title="Standard Maxlength 255">
					<div class="w-full mx-auto space-y-4 flex flex-col items-center justify-start sm:space-y-0 sm:space-x-2 sm:flex-row sm:items-end sm:justify-around">
				...
				<t-card class="mt-5" title="Standard">
					<div class="w-full mx-auto space-y-4 flex flex-col items-center justify-start sm:space-y-0 sm:space-x-2 sm:flex-row sm:items-end sm:justify-around">
                        <t-text-area showCount label="With Label" v-model="value" placeholder="placeholder" lengthText="Character Length" />
					</div>
				</t-card>

				<t-card class="mt-5" title="Standard">
					<div class="w-full mx-auto space-y-4 flex flex-col items-center justify-start sm:space-y-0 sm:space-x-2 sm:flex-row sm:items-end sm:justify-around">
                        <t-text-area showCount label="With Label" v-model="value" placeholder="placeholder" lengthText="Characters Remaining" maxLengthRemaining :maxLength="100" />
					</div>
				</t-card>
