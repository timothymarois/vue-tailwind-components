		...
		<div :class="type !== 'right' ? 'flex items-center min-h-full' : ''">
			<transition :name="transitionName" appear>
				<div
					...
					:style="`${maxWidth ? 'max-width:'+maxWidth+'px;' : ''} min-width: 300px; ${scroll ? 'margin-top: 1em; margin-bottom: 1em;' : `max-height: calc(100vh - ${type === 'center' || type === 'full' ? '4em' : '2em'});`} ${widthCalculation} ${offsetCalculation};`"
				>
